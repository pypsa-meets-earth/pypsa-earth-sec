...
def add_industry(n, costs):
    ...
    n.madd(
        ...
        p_set=demand_locations["gas fraction"].apply(lambda frac: frac * 1e6 / 8760),
    )
    ...
    n.madd(
        ...
        # TODO Multiply by gas demand and find true gas fraction
        p_set=demand_locations["H2 fraction"].apply(lambda frac: frac * 1e6 / 8760),
    )
    ...
    n.madd(
        ...
        # TODO Multiply by gas demand and find true gas fraction
        p_set=demand_locations["naphta fraction"].apply(lambda frac: frac * 1e6 / 8760),
    )
