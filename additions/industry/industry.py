...
df.to_csv(
    r"./documentation/notebooks/additions/industry/industry_cement.csv",
    sep=",",
    encoding="utf-8",
    header="true",
)
...
df_ukraine.to_csv(
    r"./documentation/notebooks/additions/industry/industry_cement_ukraine.csv",
    sep=",",
    encoding="utf-8",
    header="true",
)
...
df.to_csv(
    r"./documentation/notebooks/additions/industry/industry_steel.csv",
    sep=",",
    encoding="utf-8",
    header="true",
)
...
df.to_csv(
    r"./documentation/notebooks/additions/industry/industry_oil_refineries.csv",
    sep=",",
    encoding="utf-8",
    header="true",
)
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/facilities.xlsx"
)
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/capacity.csv"
)
...
df1 = pd.merge(
    facilities, capacity, left_on="facility_id", right_on="facility_id", how="left"
)
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/coal.csv"
)
coal = pd.read_csv(fn)
...
df = coal.copy()
df = (
    df[["facility_id", "value_tonnes"]].groupby(["facility_id"]).max().reset_index()
)  # .mean()

# Drop duplicate facilities and keep only its material
coal = (
    coal.sort_values(["facility_id"], ascending=[True])
...
df2 = pd.merge(
    df1, coal, left_on="facility_id", right_on="facility_id", how="left"
)  # .drop(columns = ['coal_facility_id'])
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/commodities.csv"
)
...
commodities = (
    commodities[["facility_id", "material", "commodity", "value_tonnes"]]
    .groupby(["facility_id", "material", "commodity"], dropna=False)
    .max()
    .reset_index()
)  # .mean()
commodities
...
# %%
df3 = pd.merge(
    df2, commodities, left_on="facility_id", right_on="facility_id", how="left"
)
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/material_ids.csv"
)
...
df4 = pd.merge(
    df3, material_ids, left_on="material", right_on="material_id", how="left"
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/minerals.csv"
)
...
minerals = (
    minerals[["facility_id", "material", "value_tonnes"]]
    .groupby(["facility_id", "material"], dropna=False)
    .max()
    .reset_index()
)  # .mean()
...
df5 = pd.merge(
    df4,
    minerals,
    left_on=["facility_id", "material"],
    right_on=["facility_id", "material"],
    how="left",
    suffixes=("", "_material"),
)
df5
...
fn = (
    os.getcwd()
    + "/documentation/notebooks/additions/industry/coal_and_ferrous/processing.csv"
)
...
df6 = pd.merge(
    df5,
    processing,
    left_on=["facility_id", "facility_type"],
    right_on=["facility_id", "facility_type"],
    how="left",
...
# %%
df6.to_csv(
    r"./documentation/notebooks/additions/industry/industry_coal_and_ferrous.csv",
    sep=",",
    encoding="utf-8",
    header="true",
)
