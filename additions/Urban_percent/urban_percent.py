...
#%%
# Read downloaded csv
urban_percent_orig = pd.read_csv(r'./documentation/notebooks/additions/Urban_percent/US_PopTotal_ST202210141520_v2.csv', index_col=0)
...
df["country"] = cc.pandas_convert(series=Economy_Label, to='ISO2', not_found='not found')  
...
#%%
# Save
df.to_csv(r'./documentation/notebooks/additions/Urban_percent/urban_percent.csv', sep=',', encoding='utf-8', header='true')