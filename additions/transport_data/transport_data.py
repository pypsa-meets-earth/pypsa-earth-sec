...
if response.status_code == 200:
    with open('/nfs/home/edd32710/projects/HyPAT/Ukraine/documentation/notebooks/additions/transport_data/CO2_emissions.xls', 'wb') as f:
...
CO2_emissions = pd.read_excel('/nfs/home/edd32710/projects/HyPAT/Ukraine/documentation/notebooks/additions/transport_data/CO2_emissions.xls', sheet_name='Data', skiprows=[0, 1, 2])
CO2_emissions


#%%
CO2_emissions = CO2_emissions[['Country Name', 'Country Code', 'Indicator Name', '2014']]
...
CO2_emissions["country"] = cc.pandas_convert(series=Country, to='ISO2', not_found='not found')  
...
merged_df.to_csv('/nfs/home/edd32710/projects/HyPAT/Ukraine/documentation/notebooks/additions/transport_data/transport_data.csv', index=False)
